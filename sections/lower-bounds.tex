...
\begin{proof}
  ...
  Now we can apply Theorem~\ref{theorem:family}:
  \begin{align*}
    \pc(n)^2 &\geq \frac{\log_2 \abs{\P_n}}{8d \left(1 + \log_2 (2\rho/\Delta) + \log_2\log_2 \abs{\P_n} \right)}\\
  ...
  Therefore $\pc(n) \geq \frac{1}{12} \sqrt{n}$.
\end{proof}
