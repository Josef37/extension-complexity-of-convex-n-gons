...
% todo: define ball (B) and norm (euclid)
...
$$ \left( \forall P\in\P: \xc(P) \leq m \Rightarrow m^2 \geq B \right) \Rightarrow \left( m^2 < B \Rightarrow \exists P\in\P: xc(P) > m \right) $$
