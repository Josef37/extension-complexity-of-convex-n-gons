...
% polish: Think about multi-dimensional proof
% polish: Think about better bound for non-cyclic polygons
...
Frist we have to define the \emph{Hausdorff distance} of two compact sets, which can be thought of "the longest distance you can be forced to travel from a point in one of the two sets to the other set". See Figure~\ref{fig:hausdorff} for an example.
