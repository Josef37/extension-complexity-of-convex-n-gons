...
For the proof we need the generalized ``lampshade argument'', how it was originally proved in \textcite[Lemma 3.1]{shitov2014sublinear}. It was simplified for this use case to allow simpler notation.
